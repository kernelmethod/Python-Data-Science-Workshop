...
> This course introduces the Scikit-learn library for doing machine learning in Python. Students will start by learning about support vector machines, and gradually explore the Scikit-learn interface for building a full machine learning pipeline.
